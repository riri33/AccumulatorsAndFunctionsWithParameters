...
def test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    expected = 14
    answer = sum_of_digits(167)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    expected = 19
    answer = sum_of_digits(1378)
...
def digits_in_power(n, k):
    ...
    if k < 0:
        k = -k
    cubed = n**k
    digits_sum = sum_of_digits(cubed)
    return digits_sum
    # ------------------------------------------------------------------
...
def fancy_sums_of_digits(n):
    ...
    powered = x**y
    digits_sum = sum_of_digits(powered)
    return digits_sum
